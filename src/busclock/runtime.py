...
def build_weather_snapshot(weather: CurrentWeather, config: AppConfig) -> WeatherSnapshot:
    return WeatherSnapshot(
        ...
        sea_level_hpa=weather.sea_level_hpa,
        ground_level_hpa=weather.ground_level_hpa,
        visibility_m=weather.visibility_m,
        wind_speed_mps=weather.wind_speed_mps,
        wind_direction_deg=weather.wind_direction_deg,
        wind_gust_mps=weather.wind_gust_mps,
        cloudiness_percent=weather.cloudiness_percent,
        ...
        timezone_offset_seconds=weather.timezone_offset_seconds,
